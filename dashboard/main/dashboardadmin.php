<?php
/**
 * Path: Project/dashboard/main/dashboardadmin.php
 * To reach the root (Project/), we need to go UP two levels.
 */
$root = dirname(__DIR__, 2); 

// 1. Correct paths to required files
// Adjust 'auth/auth.php' if your auth file is just in the root 'Project/auth.php'
require_once $root . '/auth/login.php'; 

$pageTitle = 'Admin Dashboard | Recycle Centers';
$pdo = getDB();
$msg = '';
$msgType = '';
...
// 2. Adjust Layout paths (point to where these files actually live)
require_once $root . '/recycle/admin/_layout.php'; 
?>
    ...
    <tbody>
      ...
      <tr style="<?= !$c['is_active']?'opacity:.5':'' ?>">
        ...
        <td>
          ...
          <a href="dashboardadmin.php?edit=<?= $c['id'] ?>" class="btn-edit btn-sm">Edit</a>
...
<div class="form-card" style="max-width:none">
  ...
  <form method="POST">
    ...
    <div style="display:flex;flex-direction:column;gap:13px">
      ...
      <?php if($editCenter): ?>
      <a href="dashboardadmin.php" class="btn-edit" style="display:block;text-align:center;padding:10px">✕ Cancel Edit</a>
      <?php endif; ?>
    </div>
  </form>
</div>
...
<?php require_once $root . '/recycle/admin/_layout_end.php'; ?>